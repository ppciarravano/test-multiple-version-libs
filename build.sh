...
g++ -Wl,-rpath=. -Wl,-soname,liboiio.so.1 -shared -o liboiio.so.1.0 oiio.o  ../libtiff_4/libtiff.a
ldconfig -N -f ../ld.so.conf
...
g++ -Wl,-rpath=. -Wl,-soname,libusd.so.1 -shared -o libusd.so.1.0 usd.o -L../oiio -loiio
ldconfig -N -f ../ld.so.conf
...
g++ -Wl,-rpath=. -o maya maya.o  -ldl ../libtiff_3/libtiff.so
cd ..
